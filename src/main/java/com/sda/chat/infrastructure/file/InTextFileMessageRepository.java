...
public class InTextFileMessageRepository implements MessagesRepository {

    private File file;
    private PrintWriter out;
    private List<ChatMessage> messages;

    public InTextFileMessageRepository(String filePath, UsersRepository usersRepository) throws FileNotFoundException {
    ...
    private void init(UsersRepository usersRepository) throws FileNotFoundException {
        ...
        while (scanner.hasNextLine()) {
            ...
            String message = split[3]; //TODO pobierać pozostałe elementy do message

            ChatMessage chatMessage = new ChatMessage(usersRepository.findByName(receiverName),
