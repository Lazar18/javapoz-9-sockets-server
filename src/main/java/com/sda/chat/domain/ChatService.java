...
import com.sda.chat.api.InvalidComandException;
...
public class ChatService {
    ...
    public ChatUser authenticate(String message, String address) {
        ...
        if (!"hello".equals(splitMessage[0])) {
            throw new InvalidComandException("Invalid command: " + splitMessage[0]);
        }
    ...
    private String handleMessages(ChatUser chatUser, String[] splitMessage) {
        if (splitMessage.length == 1) {
            ...
            for (ChatMessage chatMessage : messages) {
                ChatUser interlocutor = getInterlocutor(chatUser, chatMessage);
    ...
    private ChatUser getInterlocutor(ChatUser chatUser, ChatMessage chatMessage) {
    ...
    private String handleSendMessage(ChatUser sender, String[] splitMessage) {
